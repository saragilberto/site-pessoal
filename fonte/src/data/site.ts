...
export const pt: SiteContent = {
  ...
  approach: {
    ...
    items: [
      ...
      {
        n: '03',
        title: 'IA sobre dados reais',
        body: 'Agentes de IA operam sobre os dados reais dos produtos via MCP, sob o mesmo escopo de permissão de cada tenant — ferramentas para o time técnico e de suporte, não um chatbot exposto ao cliente final.',
      },
      {
        n: '04',
    ...
    cases: [
      {
        ...
        body: 'Plataforma multi-tenant para o órgão público planejar e executar suas contratações: Plano Anual de Contratações (PCA) com Documento de Formalização de Demanda (DFD) por objeto, consolidação incremental e controle de exercício com alertas de prazo. Checklist de conformidade por variante de processo, com parecer gerado por IA, catálogo de produtos e cadastro geral de fornecedores e responsáveis.',
        ...
        tags: ['Laravel modular', 'PostgreSQL multi-tenant', 'Vue 3 + Inertia', 'Parecer de IA'],
      ...
      },
      {
        ...
        body: 'Plataforma que centraliza o conhecimento e o atendimento da empresa, hoje fragmentados entre os demais produtos: fila de chamados com classificação e SLA, wiki interna com busca full-text e um motor de busca híbrida (RAG) sobre manuais, artigos e documentação técnica. Esse conhecimento é exposto via MCP a um LLM local, usado como agente conversacional de suporte e para code completion no desenvolvimento.',
        ...
        tags: ['Laravel modular', 'PostgreSQL multi-tenant', 'Vue 3 + Inertia', 'Busca híbrida (RAG) + LLM local'],
        roles: 'Arquitetura · Backend · Frontend · IA',
      },
    ],
  },
  ...
  stack: {
    ...
    groups: [
      ...
      {
        title: 'IA',
        items: ['MCP Servers', 'RAG + LLM local (suporte e code completion)', 'Tool use sob escopo do tenant'],
      },
    ],
  },
  about: {
    ...
    paragraphs: [
      ...
      'Trabalho com agentes de IA que operam sobre os dados reais dos produtos via MCP, sob o mesmo escopo de permissão de cada tenant — ferramentas internas para o time técnico e de suporte, não uma camada de chat para o cliente final. Também supervisiono um estagiário e escrevo a documentação de onboarding: parte do meu trabalho é fazer com que outra pessoa consiga entrar no código sem precisar me perguntar.',
    ],
    motto:
...
export const en: SiteContent = {
  ...
  approach: {
    ...
    items: [
      ...
      {
        n: '03',
        title: 'AI on real data',
        body: 'AI agents operate on the products\' real data through MCP, under each tenant\'s permission scope — tooling for the technical and support team, not a chatbot exposed to the end customer.',
      },
      {
        n: '04',
    ...
    cases: [
      {
        ...
        body: 'Multi-tenant platform for public-sector agencies to plan and run their own procurement processes: an Annual Procurement Plan (PCA) with a Demand Formalization Document (DFD) per item, incremental consolidation and fiscal-year controls with deadline alerts. A compliance checklist per process variant, with an AI-generated opinion, a product catalogue and a general registry of suppliers and responsible parties.',
        ...
        tags: ['Modular Laravel', 'Multi-tenant PostgreSQL', 'Vue 3 + Inertia', 'AI-generated opinion'],
      ...
      },
      {
        ...
        body: 'A platform that centralizes the company knowledge and support, today split across the other products: a ticket queue with classification and SLAs, an internal wiki with full-text search, and a hybrid search engine (RAG) over manuals, articles and technical docs. That knowledge is exposed through MCP to a local LLM, used as a support chat agent and for code completion during development.',
        ...
        tags: ['Modular Laravel', 'Multi-tenant PostgreSQL', 'Vue 3 + Inertia', 'Hybrid search (RAG) + local LLM'],
        roles: 'Architecture · Backend · Frontend · AI',
      },
    ],
  },
  ...
  stack: {
    ...
    groups: [
      ...
      {
        title: 'AI',
        items: ['MCP Servers', 'RAG + local LLM (support and code completion)', 'Tool use scoped to the tenant'],
      },
    ],
  },
  about: {
    ...
    paragraphs: [
      ...
      'I work with AI agents that operate on the products\' real data through MCP, under each tenant\'s permission scope — internal tooling for the technical and support team, not a chat layer for the end customer. I also supervise an intern and write the onboarding documentation: part of my job is making sure someone else can get into the code without having to ask me.',
    ],
    motto:
